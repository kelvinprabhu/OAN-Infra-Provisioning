###############################################################
# OAN-Infra-Provisioning | Azure | BOX
...
terraform {
  ...
  backend "azurerm" {
    ...
    storage_account_name = "oantfstateazurebox"
    container_name       = "tfstate"
    key                  = "azure/box/terraform.tfstate"
  }
}
...
module "database" {
  ...
  db_admin_login_secret    = "oan-azure-box-db-admin-login"
  db_admin_password_secret = "oan-azure-box-db-admin-password"
}
