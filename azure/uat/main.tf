###############################################################
# OAN-Infra-Provisioning | Azure | UAT
...
terraform {
  ...
  backend "azurerm" {
    ...
    storage_account_name = "oantfstateazureuat"
    container_name       = "tfstate"
    key                  = "azure/uat/terraform.tfstate"
  }
}
...
module "database" {
  ...
  db_admin_login_secret    = "oan-azure-uat-db-admin-login"
  db_admin_password_secret = "oan-azure-uat-db-admin-password"
}
