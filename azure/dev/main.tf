###############################################################
# OAN-Infra-Provisioning | Azure | DEV
...
terraform {
  ...
  backend "azurerm" {
    ...
    storage_account_name = "oantfstateazuredev"
...
module "database" {
  ...
  db_admin_login_secret    = "oan-azure-dev-db-admin-login"
  db_admin_password_secret = "oan-azure-dev-db-admin-password"
}
